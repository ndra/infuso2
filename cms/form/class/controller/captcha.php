...
class Captcha extends Core\Controller {
    ...
    public function index($p) {                   
        ...
        $fonts = array();
        $fontsdir_absolute = \Infuso\Core\File::get(self::inspector()->bundle()->path()."/captcha-fonts/")->native();
        ...
        if($p["name"] == null){$name="captcha_keystring";}else{$name = $p["name"];}
        
        //app()->session($name, $this->getKeyString());
