...
namespace NDRA\Plugins\Carousel;
use \Infuso\Core;
...
class Test extends Core\Controller {
	...
	public static function index() {
	    ...
	    \tmp::header();
	    \tmp::head("<style>.prevDisabled,.nextDisabled{color:#ededed;} .xxx {font-weight:bold}</style>");
		...
		\NDRA\Plugins\Carousel\Builder::create(".c1")
			->spacing(100)
		...
		\NDRA\Plugins\Carousel\Builder::create(".c2")
			->minWidth(400)
			->height(150)
			->spacing(1)
			->offset(1)
		...
		\NDRA\Plugins\Carousel\Builder::create(".c3")
			->minWidth(3000)
			->prev(".prev")
			->next(".next")
			->container(".container")
		...
		\NDRA\Plugins\Carousel\Builder::create(".c4")
			->minWidth(3000)
			->prev(".prev","prevDisabled")
			->next(".next","nextDisabled")
			->container(".container")
        ...
        \NDRA\Plugins\Carousel\Builder::create(".c5")
            ->vertical()
            ->spacing(100)
            ->prev(".prev","prevDisabled")
            ->next(".next","nextDisabled")
